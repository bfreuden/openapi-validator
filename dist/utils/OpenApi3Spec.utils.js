...
const serversPropertyNotProvidedOrIsEmptyArray = (spec) => !Object.prototype.hasOwnProperty.call(spec, 'servers') ||
    !spec.servers.length;
...
const getPossibleConcreteBasePaths = (basePath, serverVariables) => {
    ...
    const combinationsOfBasePathVariableValues = combos_1.default(mapOfServerVariablesToPossibleValues);
